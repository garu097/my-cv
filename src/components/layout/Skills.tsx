import {LIST_ITEM_NAVBAR, SKILLS} from "@/constant";
            ...
            <Fade style={{width: '100%'}}>
                <div className={styles.content_section}>
                    <div className={styles.content_container}>
                        ...
                        <div>
                            {Object.keys(SKILLS.LANGUAGE).map(key => <ProgressInput key={key}
                    ...
                    <div className={styles.content_container}>
                        ...
                        <div>
                            {Object.keys(SKILLS.FRAMEWORK).map(key => <ProgressInput key={key}
