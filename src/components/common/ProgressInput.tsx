...
import styles from '@/styles/common/progressInput.module.css';
        ...
        <>
            <div className={styles.progressbar}>
                <svg className={styles.progressbar__svg}>
                    <motion.circle cx="80" cy="80" r="70"
                ...
                <p
                    className={clsx(styles.progressbar__text, styles.shadow)}>{props.name}<br/>
                    <motion.span
                        initial={{opacity: 0}}
                        animate={{opacity: 1}}
